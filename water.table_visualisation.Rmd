...
col.names <- c("No unique de sonde", "Mesure de la sonde (heure de lecture au bulleur; cm)")
...
col.names =  c("No unique de sonde", "Mesure de la sonde (heure de lecture au bulleur; cm)", "Bulleur (cm)"),
align = "ccc") %>% 
