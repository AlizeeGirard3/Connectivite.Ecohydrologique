...
tidy.cal.bulleur.data.list <- readRDS("connectivite/data/clean/tidy.cal.bulleur.data.list.RDS")
vérif <- do.call(rbind, tidy.cal.bulleur.data.list)
vérif.1 <- vérif %>% dplyr::filter(!grepl("rejected", vérif$measure_status)) %>% 
